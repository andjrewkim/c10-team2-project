#!/usr/bin/env python3
"""Capture IMU data from an ESP32 BMI270 and plot the reconstructed trajectory.

Ported from ``lab04-imu-lab/IMU_lab_students/tools/capture_trajectory.py``.
"""
...
class CaptureTrajectoryGui:
    ...
    def update_live_trajectory(self):
        try:
            result = compute_trajectory_from_samples(self.recorded_samples, self.baseline_samples, self.args)
        except ValueError:
            return
