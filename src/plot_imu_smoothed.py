...
Ported from ``lab04-imu-lab/IMU_lab_students/tools/plot_imu_smoothed_TODO.py``.
...
from src.sensors.lab_integration.imu import MovingAverageFilter, parse_imu_line
